<template>
  <div class="hello">
    ...
    >
      <i @click="openPlayerInputAdd" class="fas fa-plus-circle"
        ><span>Add Player</span></i
      >
      <i @click="openPlayerInputRemove" class="fas fa-minus-circle"
        ><span>Remove Player</span></i
      >
    </div>
    ...
    <div v-if="showPlayerInputRemove && team" class="section">
      ...
      <select
        class="custom-select"
        id="playerToRemove"
        v-model="selectedPlayerToRemove"
      >
